...
class AdUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        // Kiểm tra nếu đang cập nhật một quảng cáo đã có ảnh
        if (!$this->hasFile('img_thumbnail') && !$this->route('ad')->img_thumbnail) {
            $rules['img_thumbnail'] = 'required|image|max:2048'; 
        }
